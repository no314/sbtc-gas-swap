...
export function tierNameOf(value) {
...
export const DLMM_MIN_OUTPUT_USTX = 100000000n; // 100 STX
// Amount thresholds for the default tier and slippage (sats).
export const SMALL_SWAP_MAX_SATS = 30000n; // up to here: low tier, 10 percent slippage
export const LARGE_SWAP_MIN_SATS = 10000000n; // from here: high tier
