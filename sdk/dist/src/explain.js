const RELAY = {
    ...
    MIN_OUT_BELOW_TIER: { title: "The minimum output would not cover the rebate.", action: "Raise the amount, lower the tier, or lower the slippage.", retryable: true },
...
export function explainRelayError(code) {
...
export function explainTxFailure(status, result) {
