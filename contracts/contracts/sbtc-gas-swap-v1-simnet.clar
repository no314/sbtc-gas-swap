;; GENERATED by scripts/build-simnet-variant.mjs from sbtc-gas-swap-v1.clar. Do not edit.
...
(define-private (sponsor-principal)
  (contract-call? .mock-sponsor get-sponsor)
)
...
(define-private (swap-bitflow-xyk (net uint) (min-out uint))
  (contract-call? .mock-xyk-core swap-x-for-y
...
(define-private (swap-velar (net uint) (min-out uint))
  (let (
      (result (try! (contract-call? .mock-velar-pool swap
        'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token
...
(define-private (swap-bitflow-dlmm (net uint) (min-out uint))
  (let (
      (result (try! (contract-call? .mock-dlmm-router swap-y-for-x-simple-multi
